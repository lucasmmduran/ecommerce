...
{block name='page_content'}
  {block name='cms_sub_categories'}
    {if $sub_categories}
      <p>{l s='List of sub categories in %name%:' d='Shop.Theme.Catalog' sprintf=['%name%' => $cms_category.name]}</p>
      <ul>
  ...
  {block name='cms_sub_pages'}
    {if $cms_pages}
      <p>{l s='List of pages in %name%:' d='Shop.Theme.Catalog' sprintf=['%name%' => $cms_category.name]}</p>
      <ul>
