...
{block name='page_content_container' prepend}
    <section id="content-hook_order_confirmation" class="card col-xs-12 col-sm-12">
      <div class="card-block">
		...
		<p>Si selecciono la opcion Retiro en tienda, pase por nuestro local que lo vamos a estar esperando!</p>
		<p>Si selecciono envio a domicilio nos pondremos en contacto con usted dentro de las 24hs para coordinar la entrega.</p><p>Muchas gracias!</p>
		<p>              
...
{block name='page_content_container'}
  <section style="margin-bottom: 80px;" id="content" class="page-content page-order-confirmation card col-xs-12 col-sm-12">
    <div class="card-block">
      <div class="row">
