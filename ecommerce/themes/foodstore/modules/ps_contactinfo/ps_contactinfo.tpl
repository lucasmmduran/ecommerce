  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-12 col-md-6">
        <h4 class="text-uppercase title-footer-block block-contact-title">Quienes somos</h4>

        {if isset($tc_config.YBC_TC_WELCOME_TEXT) && $tc_config.YBC_TC_WELCOME_TEXT}
          <div class="des_footer">
              {$tc_config.YBC_TC_WELCOME_TEXT nofilter}
          </div>
        {/if}
      </div>

      <div class="col-xs-12 col-md-6">
        <h4 class="text-uppercase title-footer-block block-contact-title">Donde encontrarnos</h4>
