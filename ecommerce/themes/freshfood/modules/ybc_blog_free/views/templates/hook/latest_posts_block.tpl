                ...
                <div id="ybc-blog-posts-home-list" class="block_content">
                    {foreach from=$posts item='post'}  
                            <div class="ybc_block_latest_item{if isset($tc_config.YBC_TC_FLOAT_CSS3) && $tc_config.YBC_TC_FLOAT_CSS3 == 1} wow zoomIn{/if}">
                                ...
                                <div class="ybc-blog-latest-post-content ybc-blog-home-content-show">
