      ...
      {block name='breadcrumb'}
        ...
        <div class="container">
          ...
          {block name="content_wrapper"}
            <div id="content-wrapper" class="{if isset($blog_config.YBC_BLOG_FREE_SIDEBAR_POSITION) && $blog_config.YBC_BLOG_FREE_SIDEBAR_POSITION=='left'}left-column col-xs-12 col-sm-8 col-md-9{elseif isset($blog_config.YBC_BLOG_FREE_SIDEBAR_POSITION) && $blog_config.YBC_BLOG_FREE_SIDEBAR_POSITION=='right'}right-column col-xs-12 col-sm-8 col-md-9 {else} col-xs-12 col-sm-12{/if}">
              {block name="content"}
                                ...
                                <div class="ybc-blog-latest-toolbar">
                                    ...
                                    {if $show_date}
                                        ...
                                        <span class="post-date">
                                            {l s='Posted on' mod='ybc_blog_free'}:
                        ...
                        {if $blog_post.related_posts}
                            <div class="ybc-blog-related-posts ybc_blog_free_related_posts_type_{if $blog_related_posts_type}{$blog_related_posts_type|escape:'html':'UTF-8'}{else}default{/if}">
                                <h4 class="h1 products-section-title text-uppercase">
                                    <span><i class="fa fa-pencil-square-o"></i>{l s='Related posts' mod='ybc_blog_free'}</span>
                                </h4>
                                        ...
                                        {foreach from=$blog_post.related_posts item='rpost'}                                            
                                            <li class="ybc-blog-related-posts-list-li thumbnail-container">
                                                ...
                                                <div class="ybc-blog-sidear-post-meta">
                                                    ...
                                                    {/if*}
                                                    <span class="post-date">
                                                        {l s='Post on ' d='Shop.Theme'}
                                                        {if isset($blog_config.YBC_BLOG_FREE_DATE_FORMAT)&&$blog_config.YBC_BLOG_FREE_DATE_FORMAT}
                                                            <span>{date($blog_config.YBC_BLOG_FREE_DATE_FORMAT, strtotime($rpost.datetime_added))|escape:'html':'UTF-8'}</span>
                                                        {else}
                                                            {date('F jS Y', strtotime($rpost.datetime_added))|escape:'html':'UTF-8'}
                                                        {/if}
                                                    </span>
                                                </div>
