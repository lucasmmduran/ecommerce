...
*}
{if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LayoutHome2' || $tc_config.YBC_TC_LAYOUT == 'LayoutHome3'}
    <script type="text/javascript">
        var width_slider = 873;
        var height_slider = 520;
    </script>
{else if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LayoutHome6'}
    <script type="text/javascript">
        var width_slider = 1173;
        var height_slider = 520;
    </script>
{else}
    <script type="text/javascript">
...
{if isset($mls_slides) && $mls_slides}
    <div class="ets_multilayerslider{if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LayoutHome2' || $tc_config.YBC_TC_LAYOUT == 'LayoutHome3'} ets_multilayerslider_type2{/if}{if $mls_configs.ETS_MLS_SLIDER_TYPE=='full'}hidden{/if}">
        <div class="mls_slides">
        <div data-max-slide-time="{$mls_max_slide_time|intval}" 
            class="mls_slider {if $mls_configs.ETS_MLS_ENABLE_LOADING_ICON}loading{/if} 
            {if isset($mls_configs.ETS_MLS_SLIDER_TYPE)}mls_slider_type_{strtolower($mls_configs.ETS_MLS_SLIDER_TYPE)|escape:'html':'UTF-8'}{/if} mls_layout_{$mls_layout|escape:'html':'UTF-8'}" 
            style="
            {if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LayoutHome2' || $tc_config.YBC_TC_LAYOUT == 'LayoutHome3'}
                width: 873px; height: 520px; 
            {else if $tc_config.YBC_TC_LAYOUT == 'LayoutHome6'}
                width: 1173px; height: 520px; 
            {else}
                width: {$mls_width|intval}px; height: {$mls_height|intval}px; 
            {/if}
            {if $mls_configs.ETS_MLS_SLIDER_BACKGROUND} background-color: {$mls_configs.ETS_MLS_SLIDER_BACKGROUND|escape:'html':'UTF-8'};{/if}" 
            {hook h='displayMLSConfigs'}>
