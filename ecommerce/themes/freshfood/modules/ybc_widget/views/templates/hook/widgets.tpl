...
{if $widgets}
    {if $widget_hook == "display-top-column" }
        <div class="home_widget_top_column{if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LayoutHome2' || $tc_config.YBC_TC_LAYOUT == 'LayoutHome3'} col-sm-3 col-xs-12{/if}">
                        ...
                        <div class="ybc-widget-item-wrap">
                            <div class="ybc-widget-item-content">
                                ...
                                {if $widget.show_image && $widget.image}{if $widget.link}
                                    ...
                                    {if $widget.show_image && $widget.image}{if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT3'}style="background-image:url( {$link->getMediaLink("`$smarty.const._MODULE_DIR_`ybc_widget/images/widget/`$widget.image|escape:'htmlall':'UTF-8'`")});"{/if}{/if}>{/if}
                                    <img src="{$link->getMediaLink("`$smarty.const._MODULE_DIR_`ybc_widget/images/widget/`$widget.image|escape:'htmlall':'UTF-8'`")}" />{if $widget.link}
                                    </a>
                                {/if}
                                {/if}
            ...
            <ul class="ybc-widget-{$widget_hook|escape:'html':'UTF-8'} block_content">
                {foreach from=$widgets item='widget'}
                    <li class="ybc-widget-item">
                        ...
                        {if $widget.icon}<i class="fa  {$widget.icon|escape:'html':'UTF-8'}"></i>{/if}
                        {if $widget.show_image && $widget.image}{if $widget.link}<a href="{$widget.link|escape:'html':'UTF-8'}">{/if}<img src="{$link->getMediaLink("`$smarty.const._MODULE_DIR_`ybc_widget/images/widget/`$widget.image|escape:'htmlall':'UTF-8'`")}" />{if $widget.link}</a>{/if}{/if}
    ...
    {else if ($widget_hook == "ybc-custom-3")}
            <ul class="ybc-widget-{$widget_hook|escape:'html':'UTF-8'}">
                {foreach from=$widgets item='widget'}
                    <li class="ybc-widget-item {if isset($tc_config.YBC_TC_FLOAT_CSS3) && $tc_config.YBC_TC_FLOAT_CSS3 == 1} wow zoomIn{/if}">
                        <div class="container">
                            <div class="ybc_hook_custom3_content" {if $widget.show_image && $widget.image}style="background-image:url( {$link->getMediaLink("`$smarty.const._MODULE_DIR_`ybc_widget/images/widget/`$widget.image|escape:'htmlall':'UTF-8'`")});"{/if}>
                                {if $widget.icon}<i class="fa  {$widget.icon|escape:'html':'UTF-8'}"></i>{/if}
                                {if $widget.show_title && $widget.title}<h4 class="ybc-widget-title">{if $widget.link}<a href="{$widget.link|escape:'html':'UTF-8'}">{/if} {$widget.title|escape:'html':'UTF-8'}{if $widget.link}</a>{/if}</h4>{/if}
                                {if $widget.show_description && $widget.description}<div class="ybc-widget-description">{$widget.description nofilter}</div>{/if}
                            </div>
    ...
    {else if ($widget_hook == "ybc-custom-2")}
             <ul class="ybc-widget-ybc-custom-2 col-xs-12 col-sm-12 {if isset($tc_config.YBC_TC_ENABLE_SEARCHED) && $tc_config.YBC_TC_ENABLE_SEARCHED != 1} hidden-xs-down{/if}">
                <li class="widget_title_custom">{l s='Most searched keywords:' d='Shop.Theme'}</li>
                {foreach from=$widgets item='widget'}
                    <li class="ybc-widget-item">
                        {if $widget.icon}<i class="fa  {$widget.icon|escape:'html':'UTF-8'}"></i>{/if}
                        {if $widget.show_image && $widget.image}
                            {if $widget.link}
                                <a class="ybc_widget_link_img" href="{$widget.link|escape:'html':'UTF-8'}">
                                    <img src="{$link->getMediaLink("`$smarty.const._MODULE_DIR_`ybc_widget/images/widget/`$widget.image|escape:'htmlall':'UTF-8'`")}" />
                                </a>
                            {/if}
                        {/if}
                    ...
                    <li class="ybc-widget-item">
                        <div class="ybc-widget-item-content">
                            ...
                            {if $widget.show_image && $widget.image}
                                {if $widget.link}
                                    <a class="ybc_widget_link_img" href="{$widget.link|escape:'html':'UTF-8'}"
                                        {if $widget.show_image && $widget.image}{if isset($tc_config.YBC_TC_LAYOUT) && $tc_config.YBC_TC_LAYOUT == 'LAYOUT3'}style="background-image:url( {$link->getMediaLink("`$smarty.const._MODULE_DIR_`ybc_widget/images/widget/`$widget.image|escape:'htmlall':'UTF-8'`")});"{/if}{/if}>
                                        <img src="{$link->getMediaLink("`$smarty.const._MODULE_DIR_`ybc_widget/images/widget/`$widget.image|escape:'htmlall':'UTF-8'`")}" />
                                    </a>
                                {/if}
                            {/if}
    ...
    {else if $widget_hook == "ybc-custom-5"}
        <div class="ybc-widget-{$widget_hook|escape:'html':'UTF-8'}-wrapper sang">
            <div class="container">
                <ul class="ybc-widget-{$widget_hook|escape:'html':'UTF-8'}">
                    {foreach from=$widgets item='widget'}
                        <li class="ybc-widget-item col-sm-3 col-md-3{if isset($tc_config.YBC_TC_FLOAT_CSS3) && $tc_config.YBC_TC_FLOAT_CSS3 == 1} wow zoomIn{/if}">
                            <div class="ybc-widget-item-content">                        
                                <div class="content_toggle ybc_links_page_home">
                                    <div class="ybc-widget-item-content-top">
                                        {if $widget.icon}<i class="fa  {$widget.icon|escape:'html':'UTF-8'}"></i>{/if}
                                        {if $widget.show_image && $widget.image}
                                    ...
                                    {if $widget.show_description && $widget.description}
                                        <div class="ybc-widget-description">
                                            ...
                                            {if $widget.link}
                                            <a class="button" href="{$widget.link|escape:'html':'UTF-8'}">
                                                {l s='Shop now' d='Shop.Theme.Action'}
                                            </a>
                                            {/if}
                                        </div>
                                    {/if}
    ...
    {else if $widget_hook == "display-home"}
        <ul class="ybc-widget-ybc-custom-3 col-xs-12 col-sm-12 {if isset($tc_config.YBC_TC_ENABLE_BANNER) && $tc_config.YBC_TC_ENABLE_BANNER != 1} hidden-xs-down{/if}">
            {foreach from=$widgets item='widget'}
                <li class="ybc-widget-item">
                    <div class="ybc-widget-item-content">
                        {if $widget.icon}<i class="fa  {$widget.icon|escape:'html':'UTF-8'}"></i>{/if}
