...
*}
<div id="block_various_links_footer" class="links col-sm-3 col-xs-12">
  {foreach $linkBlocks as $linkBlock}
    <div class="wrapper">
      <h3 class="h3 title-footer-block hidden-xs-down"> {$linkBlock.title|escape:'html':'UTF-8'}</h3>
      {assign var=_expand_id value=10|mt_rand:100000}
      <div class="title clearfix hidden-sm-up" data-target="#footer_sub_menu_{$_expand_id|escape:'html':'UTF-8'}" data-toggle="collapse">
