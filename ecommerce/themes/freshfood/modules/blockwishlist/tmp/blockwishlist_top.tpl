...
{*
<a class="wishtlist_top nav_link" href="{$link->getModuleLink('blockwishlist', 'mywishlist', array(), true)|escape:'html':'UTF-8'}">
    <i class="fa fa-heart-o"></i> {l s='Wishlist' mod='blockwishlist'}
</a>*}