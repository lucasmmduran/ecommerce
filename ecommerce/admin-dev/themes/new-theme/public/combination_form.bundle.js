(()=>{var e={4431:function(e,t,i){var r;!function(n){"use strict";var o,s=/^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i,a=Math.ceil,c=Math.floor,p="[BigNumber Error] ",l=p+"Number primitive has more than 15 significant digits: ",u=1e14,d=14,h=9007199254740991,m=[1,10,100,1e3,1e4,1e5,1e6,1e7,1e8,1e9,1e10,1e11,1e12,1e13],f=1e7,g=1e9;function b(e){var t=0|e;return e>0||e===t?t:t-1}function w(e){for(var t,i,r=1,n=e.length,o=e[0]+"";r<n;){for(t=e[r++]+"",i=d-t.length;i--;t="0"+t);o+=t}for(n=o.length;48===o.charCodeAt(--n););return o.slice(0,n+1||1)}function y(e,t){var i,r,n=e.c,o=t.c,s=e.s,a=t.s,c=e.e,p=t.e;if(!s||!a)return null;if(i=n&&!n[0],r=o&&!o[0],i||r)return i?r?0:-a:s;if(s!=a)return s;if(i=s<0,r=c==p,!n||!o)return r?0:!n^i?1:-1;if(!r)return c>p^i?1:-1;for(a=(c=n.length)<(p=o.length)?c:p,s=0;s<a;s++)if(n[s]!=o[s])return n[s]>o[s]^i?1:-1;return c==p?0:c>p^i?1:-1}function x(e,t,i,r){if(e<t||e>i||e!==c(e))throw Error(p+(r||"Argument")+("number"==typeof e?e<t||e>i?" out of range: ":" not an integer: ":" not a primitive number: ")+String(e))}function S(e){var t=e.c.length-1;return b(e.e/d)==t&&e.c[t]%2!=0}function v(e,t){return(e.length>1?e.charAt(0)+"."+e.slice(1):e)+(t<0?"e":"e+")+t}function _(e,t,i){var r,n;if(t<0){for(n=i+".";++t;n+=i);e=n+e}else if(++t>(r=e.length)){for(n=i,t-=r;--t;n+=i);e+=n}else t<r&&(e=e.slice(0,t)+"."+e.slice(t));return e}o=function e(t){var i,r,n,o,I,P,E,N,T,O,C=L.prototype={constructor:L,toString:null,valueOf:null},F=new L(1),M=20,D=4,k=-7,R=21,B=-1e7,A=1e7,$=!1,j=1,G=0,Z={prefix:"",groupSize:3,secondaryGroupSize:0,groupSeparator:",",decimalSeparator:".",fractionGroupSize:0,fractionGroupSeparator:" ",suffix:""},U="0123456789abcdefghijklmnopqrstuvwxyz",z=!0;function L(e,t){var i,o,a,p,u,m,f,g,b=this;if(!(b instanceof L))return new L(e,t);if(null==t){if(e&&!0===e._isBigNumber)return b.s=e.s,void(!e.c||e.e>A?b.c=b.e=null:e.e<B?b.c=[b.e=0]:(b.e=e.e,b.c=e.c.slice()));if((m="number"==typeof e)&&0*e==0){if(b.s=1/e<0?(e=-e,-1):1,e===~~e){for(p=0,u=e;u>=10;u/=10,p++);return void(p>A?b.c=b.e=null:(b.e=p,b.c=[e]))}g=String(e)}else{if(!s.test(g=String(e)))return n(b,g,m);b.s=45==g.charCodeAt(0)?(g=g.slice(1),-1):1}(p=g.indexOf("."))>-1&&(g=g.replace(".","")),(u=g.search(/e/i))>0?(p<0&&(p=u),p+=+g.slice(u+1),g=g.substring(0,u)):p<0&&(p=g.length)}else{if(x(t,2,U.length,"Base"),10==t&&z)return W(b=new L(e),M+b.e+1,D);if(g=String(e),m="number"==typeof e){if(0*e!=0)return n(b,g,m,t);if(b.s=1/e<0?(g=g.slice(1),-1):1,L.DEBUG&&g.replace(/^0\.0*|\./,"").length>15)throw Error(l+e)}else b.s=45===g.charCodeAt(0)?(g=g.slice(1),-1):1;for(i=U.slice(0,t),p=u=0,f=g.length;u<f;u++)if(i.indexOf(o=g.charAt(u))<0){if("."==o){if(u>p){p=f;continue}}else if(!a&&(g==g.toUpperCase()&&(g=g.toLowerCase())||g==g.toLowerCase()&&(g=g.toUpperCase()))){a=!0,u=-1,p=0;continue}return n(b,String(e),m,t)}m=!1,(p=(g=r(g,t,10,b.s)).indexOf("."))>-1?g=g.replace(".",""):p=g.length}for(u=0;48===g.charCodeAt(u);u++);for(f=g.length;48===g.charCodeAt(--f););if(g=g.slice(u,++f)){if(f-=u,m&&L.DEBUG&&f>15&&(e>h||e!==c(e)))throw Error(l+b.s*e);if((p=p-u-1)>A)b.c=b.e=null;else if(p<B)b.c=[b.e=0];else{if(b.e=p,b.c=[],u=(p+1)%d,p<0&&(u+=d),u<f){for(u&&b.c.push(+g.slice(0,u)),f-=d;u<f;)b.c.push(+g.slice(u,u+=d));u=d-(g=g.slice(u)).length}else u-=f;for(;u--;g+="0");b.c.push(+g)}}else b.c=[b.e=0]}function q(e,t,i,r){var n,o,s,a,c;if(null==i?i=D:x(i,0,8),!e.c)return e.toString();if(n=e.c[0],s=e.e,null==t)c=w(e.c),c=1==r||2==r&&(s<=k||s>=R)?v(c,s):_(c,s,"0");else if(o=(e=W(new L(e),t,i)).e,a=(c=w(e.c)).length,1==r||2==r&&(t<=o||o<=k)){for(;a<t;c+="0",a++);c=v(c,o)}else if(t-=s,c=_(c,o,"0"),o+1>a){if(--t>0)for(c+=".";t--;c+="0");}else if((t+=o-a)>0)for(o+1==a&&(c+=".");t--;c+="0");return e.s<0&&n?"-"+c:c}function V(e,t){for(var i,r=1,n=new L(e[0]);r<e.length;r++){if(!(i=new L(e[r])).s){n=i;break}t.call(n,i)&&(n=i)}return n}function K(e,t,i){for(var r=1,n=t.length;!t[--n];t.pop());for(n=t[0];n>=10;n/=10,r++);return(i=r+i*d-1)>A?e.c=e.e=null:i<B?e.c=[e.e=0]:(e.e=i,e.c=t),e}function W(e,t,i,r){var n,o,s,p,l,h,f,g=e.c,b=m;if(g){e:{for(n=1,p=g[0];p>=10;p/=10,n++);if((o=t-n)<0)o+=d,s=t,f=(l=g[h=0])/b[n-s-1]%10|0;else if((h=a((o+1)/d))>=g.length){if(!r)break e;for(;g.length<=h;g.push(0));l=f=0,n=1,s=(o%=d)-d+1}else{for(l=p=g[h],n=1;p>=10;p/=10,n++);f=(s=(o%=d)-d+n)<0?0:l/b[n-s-1]%10|0}if(r=r||t<0||null!=g[h+1]||(s<0?l:l%b[n-s-1]),r=i<4?(f||r)&&(0==i||i==(e.s<0?3:2)):f>5||5==f&&(4==i||r||6==i&&(o>0?s>0?l/b[n-s]:0:g[h-1])%10&1||i==(e.s<0?8:7)),t<1||!g[0])return g.length=0,r?(t-=e.e+1,g[0]=b[(d-t%d)%d],e.e=-t||0):g[0]=e.e=0,e;if(0==o?(g.length=h,p=1,h--):(g.length=h+1,p=b[d-o],g[h]=s>0?c(l/b[n-s]%b[s])*p:0),r)for(;;){if(0==h){for(o=1,s=g[0];s>=10;s/=10,o++);for(s=g[0]+=p,p=1;s>=10;s/=10,p++);o!=p&&(e.e++,g[0]==u&&(g[0]=1));break}if(g[h]+=p,g[h]!=u)break;g[h--]=0,p=1}for(o=g.length;0===g[--o];g.pop());}e.e>A?e.c=e.e=null:e.e<B&&(e.c=[e.e=0])}return e}function H(e){var t,i=e.e;return null===i?e.toString():(t=w(e.c),t=i<=k||i>=R?v(t,i):_(t,i,"0"),e.s<0?"-"+t:t)}return L.clone=e,L.ROUND_UP=0,L.ROUND_DOWN=1,L.ROUND_CEIL=2,L.ROUND_FLOOR=3,L.ROUND_HALF_UP=4,L.ROUND_HALF_DOWN=5,L.ROUND_HALF_EVEN=6,L.ROUND_HALF_CEIL=7,L.ROUND_HALF_FLOOR=8,L.EUCLID=9,L.config=L.set=function(e){var t,i;if(null!=e){if("object"!=typeof e)throw Error(p+"Object expected: "+e);if(e.hasOwnProperty(t="DECIMAL_PLACES")&&(x(i=e[t],0,g,t),M=i),e.hasOwnProperty(t="ROUNDING_MODE")&&(x(i=e[t],0,8,t),D=i),e.hasOwnProperty(t="EXPONENTIAL_AT")&&((i=e[t])&&i.pop?(x(i[0],-g,0,t),x(i[1],0,g,t),k=i[0],R=i[1]):(x(i,-g,g,t),k=-(R=i<0?-i:i))),e.hasOwnProperty(t="RANGE"))if((i=e[t])&&i.pop)x(i[0],-g,-1,t),x(i[1],1,g,t),B=i[0],A=i[1];else{if(x(i,-g,g,t),!i)throw Error(p+t+" cannot be zero: "+i);B=-(A=i<0?-i:i)}if(e.hasOwnProperty(t="CRYPTO")){if((i=e[t])!==!!i)throw Error(p+t+" not true or false: "+i);if(i){if("undefined"==typeof crypto||!crypto||!crypto.getRandomValues&&!crypto.randomBytes)throw $=!i,Error(p+"crypto unavailable");$=i}else $=i}if(e.hasOwnProperty(t="MODULO_MODE")&&(x(i=e[t],0,9,t),j=i),e.hasOwnProperty(t="POW_PRECISION")&&(x(i=e[t],0,g,t),G=i),e.hasOwnProperty(t="FORMAT")){if("object"!=typeof(i=e[t]))throw Error(p+t+" not an object: "+i);Z=i}if(e.hasOwnProperty(t="ALPHABET")){if("string"!=typeof(i=e[t])||/^.?$|[+\-.\s]|(.).*\1/.test(i))throw Error(p+t+" invalid: "+i);z="0123456789"==i.slice(0,10),U=i}}return{DECIMAL_PLACES:M,ROUNDING_MODE:D,EXPONENTIAL_AT:[k,R],RANGE:[B,A],CRYPTO:$,MODULO_MODE:j,POW_PRECISION:G,FORMAT:Z,ALPHABET:U}},L.isBigNumber=function(e){if(!e||!0!==e._isBigNumber)return!1;if(!L.DEBUG)return!0;var t,i,r=e.c,n=e.e,o=e.s;e:if("[object Array]"=={}.toString.call(r)){if((1===o||-1===o)&&n>=-g&&n<=g&&n===c(n)){if(0===r[0]){if(0===n&&1===r.length)return!0;break e}if((t=(n+1)%d)<1&&(t+=d),String(r[0]).length==t){for(t=0;t<r.length;t++)if((i=r[t])<0||i>=u||i!==c(i))break e;if(0!==i)return!0}}}else if(null===r&&null===n&&(null===o||1===o||-1===o))return!0;throw Error(p+"Invalid BigNumber: "+e)},L.maximum=L.max=function(){return V(arguments,C.lt)},L.minimum=L.min=function(){return V(arguments,C.gt)},L.random=(o=9007199254740992,I=Math.random()*o&2097151?function(){return c(Math.random()*o)}:function(){return 8388608*(1073741824*Math.random()|0)+(8388608*Math.random()|0)},function(e){var t,i,r,n,o,s=0,l=[],u=new L(F);if(null==e?e=M:x(e,0,g),n=a(e/d),$)if(crypto.getRandomValues){for(t=crypto.getRandomValues(new Uint32Array(n*=2));s<n;)(o=131072*t[s]+(t[s+1]>>>11))>=9e15?(i=crypto.getRandomValues(new Uint32Array(2)),t[s]=i[0],t[s+1]=i[1]):(l.push(o%1e14),s+=2);s=n/2}else{if(!crypto.randomBytes)throw $=!1,Error(p+"crypto unavailable");for(t=crypto.randomBytes(n*=7);s<n;)(o=281474976710656*(31&t[s])+1099511627776*t[s+1]+4294967296*t[s+2]+16777216*t[s+3]+(t[s+4]<<16)+(t[s+5]<<8)+t[s+6])>=9e15?crypto.randomBytes(7).copy(t,s):(l.push(o%1e14),s+=7);s=n/7}if(!$)for(;s<n;)(o=I())<9e15&&(l[s++]=o%1e14);for(n=l[--s],e%=d,n&&e&&(o=m[d-e],l[s]=c(n/o)*o);0===l[s];l.pop(),s--);if(s<0)l=[r=0];else{for(r=-1;0===l[0];l.splice(0,1),r-=d);for(s=1,o=l[0];o>=10;o/=10,s++);s<d&&(r-=d-s)}return u.e=r,u.c=l,u}),L.sum=function(){for(var e=1,t=arguments,i=new L(t[0]);e<t.length;)i=i.plus(t[e++]);return i},r=function(){var e="0123456789";function t(e,t,i,r){for(var n,o,s=[0],a=0,c=e.length;a<c;){for(o=s.length;o--;s[o]*=t);for(s[0]+=r.indexOf(e.charAt(a++)),n=0;n<s.length;n++)s[n]>i-1&&(null==s[n+1]&&(s[n+1]=0),s[n+1]+=s[n]/i|0,s[n]%=i)}return s.reverse()}return function(r,n,o,s,a){var c,p,l,u,d,h,m,f,g=r.indexOf("."),b=M,y=D;for(g>=0&&(u=G,G=0,r=r.replace(".",""),h=(f=new L(n)).pow(r.length-g),G=u,f.c=t(_(w(h.c),h.e,"0"),10,o,e),f.e=f.c.length),l=u=(m=t(r,n,o,a?(c=U,e):(c=e,U))).length;0==m[--u];m.pop());if(!m[0])return c.charAt(0);if(g<0?--l:(h.c=m,h.e=l,h.s=s,m=(h=i(h,f,b,y,o)).c,d=h.r,l=h.e),g=m[p=l+b+1],u=o/2,d=d||p<0||null!=m[p+1],d=y<4?(null!=g||d)&&(0==y||y==(h.s<0?3:2)):g>u||g==u&&(4==y||d||6==y&&1&m[p-1]||y==(h.s<0?8:7)),p<1||!m[0])r=d?_(c.charAt(1),-b,c.charAt(0)):c.charAt(0);else{if(m.length=p,d)for(--o;++m[--p]>o;)m[p]=0,p||(++l,m=[1].concat(m));for(u=m.length;!m[--u];);for(g=0,r="";g<=u;r+=c.charAt(m[g++]));r=_(r,l,c.charAt(0))}return r}}(),i=function(){function e(e,t,i){var r,n,o,s,a=0,c=e.length,p=t%f,l=t/f|0;for(e=e.slice();c--;)a=((n=p*(o=e[c]%f)+(r=l*o+(s=e[c]/f|0)*p)%f*f+a)/i|0)+(r/f|0)+l*s,e[c]=n%i;return a&&(e=[a].concat(e)),e}function t(e,t,i,r){var n,o;if(i!=r)o=i>r?1:-1;else for(n=o=0;n<i;n++)if(e[n]!=t[n]){o=e[n]>t[n]?1:-1;break}return o}function i(e,t,i,r){for(var n=0;i--;)e[i]-=n,n=e[i]<t[i]?1:0,e[i]=n*r+e[i]-t[i];for(;!e[0]&&e.length>1;e.splice(0,1));}return function(r,n,o,s,a){var p,l,h,m,f,g,w,y,x,S,v,_,I,P,E,N,T,O=r.s==n.s?1:-1,C=r.c,F=n.c;if(!(C&&C[0]&&F&&F[0]))return new L(r.s&&n.s&&(C?!F||C[0]!=F[0]:F)?C&&0==C[0]||!F?0*O:O/0:NaN);for(x=(y=new L(O)).c=[],O=o+(l=r.e-n.e)+1,a||(a=u,l=b(r.e/d)-b(n.e/d),O=O/d|0),h=0;F[h]==(C[h]||0);h++);if(F[h]>(C[h]||0)&&l--,O<0)x.push(1),m=!0;else{for(P=C.length,N=F.length,h=0,O+=2,(f=c(a/(F[0]+1)))>1&&(F=e(F,f,a),C=e(C,f,a),N=F.length,P=C.length),I=N,v=(S=C.slice(0,N)).length;v<N;S[v++]=0);T=F.slice(),T=[0].concat(T),E=F[0],F[1]>=a/2&&E++;do{if(f=0,(p=t(F,S,N,v))<0){if(_=S[0],N!=v&&(_=_*a+(S[1]||0)),(f=c(_/E))>1)for(f>=a&&(f=a-1),w=(g=e(F,f,a)).length,v=S.length;1==t(g,S,w,v);)f--,i(g,N<w?T:F,w,a),w=g.length,p=1;else 0==f&&(p=f=1),w=(g=F.slice()).length;if(w<v&&(g=[0].concat(g)),i(S,g,v,a),v=S.length,-1==p)for(;t(F,S,N,v)<1;)f++,i(S,N<v?T:F,v,a),v=S.length}else 0===p&&(f++,S=[0]);x[h++]=f,S[0]?S[v++]=C[I]||0:(S=[C[I]],v=1)}while((I++<P||null!=S[0])&&O--);m=null!=S[0],x[0]||x.splice(0,1)}if(a==u){for(h=1,O=x[0];O>=10;O/=10,h++);W(y,o+(y.e=h+l*d-1)+1,s,m)}else y.e=l,y.r=+m;return y}}(),P=/^(-?)0([xbo])(?=\w[\w.]*$)/i,E=/^([^.]+)\.$/,N=/^\.([^.]+)$/,T=/^-?(Infinity|NaN)$/,O=/^\s*\+(?=[\w.])|^\s+|\s+$/g,n=function(e,t,i,r){var n,o=i?t:t.replace(O,"");if(T.test(o))e.s=isNaN(o)?null:o<0?-1:1;else{if(!i&&(o=o.replace(P,(function(e,t,i){return n="x"==(i=i.toLowerCase())?16:"b"==i?2:8,r&&r!=n?e:t})),r&&(n=r,o=o.replace(E,"$1").replace(N,"0.$1")),t!=o))return new L(o,n);if(L.DEBUG)throw Error(p+"Not a"+(r?" base "+r:"")+" number: "+t);e.s=null}e.c=e.e=null},C.absoluteValue=C.abs=function(){var e=new L(this);return e.s<0&&(e.s=1),e},C.comparedTo=function(e,t){return y(this,new L(e,t))},C.decimalPlaces=C.dp=function(e,t){var i,r,n,o=this;if(null!=e)return x(e,0,g),null==t?t=D:x(t,0,8),W(new L(o),e+o.e+1,t);if(!(i=o.c))return null;if(r=((n=i.length-1)-b(this.e/d))*d,n=i[n])for(;n%10==0;n/=10,r--);return r<0&&(r=0),r},C.dividedBy=C.div=function(e,t){return i(this,new L(e,t),M,D)},C.dividedToIntegerBy=C.idiv=function(e,t){return i(this,new L(e,t),0,1)},C.exponentiatedBy=C.pow=function(e,t){var i,r,n,o,s,l,u,h,m=this;if((e=new L(e)).c&&!e.isInteger())throw Error(p+"Exponent not an integer: "+H(e));if(null!=t&&(t=new L(t)),s=e.e>14,!m.c||!m.c[0]||1==m.c[0]&&!m.e&&1==m.c.length||!e.c||!e.c[0])return h=new L(Math.pow(+H(m),s?2-S(e):+H(e))),t?h.mod(t):h;if(l=e.s<0,t){if(t.c?!t.c[0]:!t.s)return new L(NaN);(r=!l&&m.isInteger()&&t.isInteger())&&(m=m.mod(t))}else{if(e.e>9&&(m.e>0||m.e<-1||(0==m.e?m.c[0]>1||s&&m.c[1]>=24e7:m.c[0]<8e13||s&&m.c[0]<=9999975e7)))return o=m.s<0&&S(e)?-0:0,m.e>-1&&(o=1/o),new L(l?1/o:o);G&&(o=a(G/d+2))}for(s?(i=new L(.5),l&&(e.s=1),u=S(e)):u=(n=Math.abs(+H(e)))%2,h=new L(F);;){if(u){if(!(h=h.times(m)).c)break;o?h.c.length>o&&(h.c.length=o):r&&(h=h.mod(t))}if(n){if(0===(n=c(n/2)))break;u=n%2}else if(W(e=e.times(i),e.e+1,1),e.e>14)u=S(e);else{if(0===(n=+H(e)))break;u=n%2}m=m.times(m),o?m.c&&m.c.length>o&&(m.c.length=o):r&&(m=m.mod(t))}return r?h:(l&&(h=F.div(h)),t?h.mod(t):o?W(h,G,D,undefined):h)},C.integerValue=function(e){var t=new L(this);return null==e?e=D:x(e,0,8),W(t,t.e+1,e)},C.isEqualTo=C.eq=function(e,t){return 0===y(this,new L(e,t))},C.isFinite=function(){return!!this.c},C.isGreaterThan=C.gt=function(e,t){return y(this,new L(e,t))>0},C.isGreaterThanOrEqualTo=C.gte=function(e,t){return 1===(t=y(this,new L(e,t)))||0===t},C.isInteger=function(){return!!this.c&&b(this.e/d)>this.c.length-2},C.isLessThan=C.lt=function(e,t){return y(this,new L(e,t))<0},C.isLessThanOrEqualTo=C.lte=function(e,t){return-1===(t=y(this,new L(e,t)))||0===t},C.isNaN=function(){return!this.s},C.isNegative=function(){return this.s<0},C.isPositive=function(){return this.s>0},C.isZero=function(){return!!this.c&&0==this.c[0]},C.minus=function(e,t){var i,r,n,o,s=this,a=s.s;if(t=(e=new L(e,t)).s,!a||!t)return new L(NaN);if(a!=t)return e.s=-t,s.plus(e);var c=s.e/d,p=e.e/d,l=s.c,h=e.c;if(!c||!p){if(!l||!h)return l?(e.s=-t,e):new L(h?s:NaN);if(!l[0]||!h[0])return h[0]?(e.s=-t,e):new L(l[0]?s:3==D?-0:0)}if(c=b(c),p=b(p),l=l.slice(),a=c-p){for((o=a<0)?(a=-a,n=l):(p=c,n=h),n.reverse(),t=a;t--;n.push(0));n.reverse()}else for(r=(o=(a=l.length)<(t=h.length))?a:t,a=t=0;t<r;t++)if(l[t]!=h[t]){o=l[t]<h[t];break}if(o&&(n=l,l=h,h=n,e.s=-e.s),(t=(r=h.length)-(i=l.length))>0)for(;t--;l[i++]=0);for(t=u-1;r>a;){if(l[--r]<h[r]){for(i=r;i&&!l[--i];l[i]=t);--l[i],l[r]+=u}l[r]-=h[r]}for(;0==l[0];l.splice(0,1),--p);return l[0]?K(e,l,p):(e.s=3==D?-1:1,e.c=[e.e=0],e)},C.modulo=C.mod=function(e,t){var r,n,o=this;return e=new L(e,t),!o.c||!e.s||e.c&&!e.c[0]?new L(NaN):!e.c||o.c&&!o.c[0]?new L(o):(9==j?(n=e.s,e.s=1,r=i(o,e,0,3),e.s=n,r.s*=n):r=i(o,e,0,j),(e=o.minus(r.times(e))).c[0]||1!=j||(e.s=o.s),e)},C.multipliedBy=C.times=function(e,t){var i,r,n,o,s,a,c,p,l,h,m,g,w,y,x,S=this,v=S.c,_=(e=new L(e,t)).c;if(!(v&&_&&v[0]&&_[0]))return!S.s||!e.s||v&&!v[0]&&!_||_&&!_[0]&&!v?e.c=e.e=e.s=null:(e.s*=S.s,v&&_?(e.c=[0],e.e=0):e.c=e.e=null),e;for(r=b(S.e/d)+b(e.e/d),e.s*=S.s,(c=v.length)<(h=_.length)&&(w=v,v=_,_=w,n=c,c=h,h=n),n=c+h,w=[];n--;w.push(0));for(y=u,x=f,n=h;--n>=0;){for(i=0,m=_[n]%x,g=_[n]/x|0,o=n+(s=c);o>n;)i=((p=m*(p=v[--s]%x)+(a=g*p+(l=v[s]/x|0)*m)%x*x+w[o]+i)/y|0)+(a/x|0)+g*l,w[o--]=p%y;w[o]=i}return i?++r:w.splice(0,1),K(e,w,r)},C.negated=function(){var e=new L(this);return e.s=-e.s||null,e},C.plus=function(e,t){var i,r=this,n=r.s;if(t=(e=new L(e,t)).s,!n||!t)return new L(NaN);if(n!=t)return e.s=-t,r.minus(e);var o=r.e/d,s=e.e/d,a=r.c,c=e.c;if(!o||!s){if(!a||!c)return new L(n/0);if(!a[0]||!c[0])return c[0]?e:new L(a[0]?r:0*n)}if(o=b(o),s=b(s),a=a.slice(),n=o-s){for(n>0?(s=o,i=c):(n=-n,i=a),i.reverse();n--;i.push(0));i.reverse()}for((n=a.length)-(t=c.length)<0&&(i=c,c=a,a=i,t=n),n=0;t;)n=(a[--t]=a[t]+c[t]+n)/u|0,a[t]=u===a[t]?0:a[t]%u;return n&&(a=[n].concat(a),++s),K(e,a,s)},C.precision=C.sd=function(e,t){var i,r,n,o=this;if(null!=e&&e!==!!e)return x(e,1,g),null==t?t=D:x(t,0,8),W(new L(o),e,t);if(!(i=o.c))return null;if(r=(n=i.length-1)*d+1,n=i[n]){for(;n%10==0;n/=10,r--);for(n=i[0];n>=10;n/=10,r++);}return e&&o.e+1>r&&(r=o.e+1),r},C.shiftedBy=function(e){return x(e,-9007199254740991,h),this.times("1e"+e)},C.squareRoot=C.sqrt=function(){var e,t,r,n,o,s=this,a=s.c,c=s.s,p=s.e,l=M+4,u=new L("0.5");if(1!==c||!a||!a[0])return new L(!c||c<0&&(!a||a[0])?NaN:a?s:1/0);if(0==(c=Math.sqrt(+H(s)))||c==1/0?(((t=w(a)).length+p)%2==0&&(t+="0"),c=Math.sqrt(+t),p=b((p+1)/2)-(p<0||p%2),r=new L(t=c==1/0?"5e"+p:(t=c.toExponential()).slice(0,t.indexOf("e")+1)+p)):r=new L(c+""),r.c[0])for((c=(p=r.e)+l)<3&&(c=0);;)if(o=r,r=u.times(o.plus(i(s,o,l,1))),w(o.c).slice(0,c)===(t=w(r.c)).slice(0,c)){if(r.e<p&&--c,"9999"!=(t=t.slice(c-3,c+1))&&(n||"4999"!=t)){+t&&(+t.slice(1)||"5"!=t.charAt(0))||(W(r,r.e+M+2,1),e=!r.times(r).eq(s));break}if(!n&&(W(o,o.e+M+2,0),o.times(o).eq(s))){r=o;break}l+=4,c+=4,n=1}return W(r,r.e+M+1,D,e)},C.toExponential=function(e,t){return null!=e&&(x(e,0,g),e++),q(this,e,t,1)},C.toFixed=function(e,t){return null!=e&&(x(e,0,g),e=e+this.e+1),q(this,e,t)},C.toFormat=function(e,t,i){var r,n=this;if(null==i)null!=e&&t&&"object"==typeof t?(i=t,t=null):e&&"object"==typeof e?(i=e,e=t=null):i=Z;else if("object"!=typeof i)throw Error(p+"Argument not an object: "+i);if(r=n.toFixed(e,t),n.c){var o,s=r.split("."),a=+i.groupSize,c=+i.secondaryGroupSize,l=i.groupSeparator||"",u=s[0],d=s[1],h=n.s<0,m=h?u.slice(1):u,f=m.length;if(c&&(o=a,a=c,c=o,f-=o),a>0&&f>0){for(o=f%a||a,u=m.substr(0,o);o<f;o+=a)u+=l+m.substr(o,a);c>0&&(u+=l+m.slice(o)),h&&(u="-"+u)}r=d?u+(i.decimalSeparator||"")+((c=+i.fractionGroupSize)?d.replace(new RegExp("\\d{"+c+"}\\B","g"),"$&"+(i.fractionGroupSeparator||"")):d):u}return(i.prefix||"")+r+(i.suffix||"")},C.toFraction=function(e){var t,r,n,o,s,a,c,l,u,h,f,g,b=this,y=b.c;if(null!=e&&(!(c=new L(e)).isInteger()&&(c.c||1!==c.s)||c.lt(F)))throw Error(p+"Argument "+(c.isInteger()?"out of range: ":"not an integer: ")+H(c));if(!y)return new L(b);for(t=new L(F),u=r=new L(F),n=l=new L(F),g=w(y),s=t.e=g.length-b.e-1,t.c[0]=m[(a=s%d)<0?d+a:a],e=!e||c.comparedTo(t)>0?s>0?t:u:c,a=A,A=1/0,c=new L(g),l.c[0]=0;h=i(c,t,0,1),1!=(o=r.plus(h.times(n))).comparedTo(e);)r=n,n=o,u=l.plus(h.times(o=u)),l=o,t=c.minus(h.times(o=t)),c=o;return o=i(e.minus(r),n,0,1),l=l.plus(o.times(u)),r=r.plus(o.times(n)),l.s=u.s=b.s,f=i(u,n,s*=2,D).minus(b).abs().comparedTo(i(l,r,s,D).minus(b).abs())<1?[u,n]:[l,r],A=a,f},C.toNumber=function(){return+H(this)},C.toPrecision=function(e,t){return null!=e&&x(e,1,g),q(this,e,t,2)},C.toString=function(e){var t,i=this,n=i.s,o=i.e;return null===o?n?(t="Infinity",n<0&&(t="-"+t)):t="NaN":(null==e?t=o<=k||o>=R?v(w(i.c),o):_(w(i.c),o,"0"):10===e&&z?t=_(w((i=W(new L(i),M+o+1,D)).c),i.e,"0"):(x(e,2,U.length,"Base"),t=r(_(w(i.c),o,"0"),10,e,n,!0)),n<0&&i.c[0]&&(t="-"+t)),t},C.valueOf=C.toJSON=function(){return H(this)},C._isBigNumber=!0,null!=t&&L.set(t),L}(),o.default=o.BigNumber=o,void 0===(r=function(){return o}.call(t,i,t,e))||(e.exports=r)}()},5158:(e,t,i)=>{"use strict";i.d(t,{Z:()=>r});const r=
/**
 ...
 */
class{constructor(e){this.message=e,this.name="LocalizationException"}}},1527:(e,t,i)=>{"use strict";i.d(t,{NumberFormatter:()=>c});var r=i(9475),n=i(3368),o=i(6965);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:S}=window;S((()=>{window.prestashop.component.initComponents(["TranslatableField","TinyMCEEditor","TranslatableInput","EventEmitter","TextWithLengthCounter","DeltaQuantityInput","DisablingSwitch"]);const e=S(s),{eventEmitter:t}=window.prestashop.instance,i=new w(e,t),r=new x(a.productSuppliers,i.getCombination().suppliers.defaultSupplierId,i.getCombination().price.wholesalePrice,(e=>{i.set("price.wholesalePrice",e.price)}));i.watch("price.wholesalePrice",(e=>{r.updateWholesalePrice(e.value)})),new o}))})(),window.combination_form=r})();