 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class A{extend(e){e.getHeaderContainer().on("click",I,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:M}=window;class ${extend(e){e.getHeaderContainer().on("click",r.showQuery,(()=>this.onShowSqlQueryClick(e))),e.getHeaderContainer().on("click",r.exportQuery,(()=>this.onExportSqlManagerClick(e)))}onShowSqlQueryClick(e){const t=M(r.showModalForm(e.getId()));this.fillExportForm(t,e);const s=M(r.showModalGrid(e.getId()));s.modal("show"),s.on("click",C,(()=>t.submit()))}onExportSqlManagerClick(e){const t=M(r.showModalForm(e.getId()));this.fillExportForm(t,e),t.submit()}fillExportForm(e,t){const s=t.getContainer().find(i).data("query");e.find('textarea[name="sql"]').val(s),e.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const e=M(h).find(m);let t="";return e.each(((e,s)=>{const o=M(s),r=o.find("a").length>0?o.find("a").text():o.text();t.length>0&&(t=t.concat(" > ")),t=t.concat(r)})),t}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Me}=window;class $e{constructor(){this.lockArray=[]}extend(t){t.getContainer().find(e.choiceOptions).find(l).on("click",(t=>{t.preventDefault();const s=Me(t.currentTarget),o=s.closest(e.choiceOptions).data("url");this.submitForm(o,s)}))}submitForm(e,t){const s=t.data("value");if(this.isLocked(e))return;const o=Me("<form>",{action:e,method:"POST"}).append(Me("<input>",{name:"value",value:s,type:"hidden"}));o.appendTo("body"),o.submit(),this.lock(e)}isLocked(e){return this.lockArray.includes(e)}lock(e){this.lockArray.push(e)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ge}=window;class Le{extend(t){t.getContainer().on("click",e.modalFormSubmitBtn,(s=>{const o=Ge(s.target).data("modal-id"),n=Ge(`#${o}`);n.modal("show"),n.find(r.submitModalFormBtn).on("click",(()=>{const s=n.find("form"),o=s.find(r.bulkInputsBlock(s.data("bulk-inputs-id")));t.getContainer().find(e.checkedCheckbox).each(((e,t)=>{const r=Ge(t),n=o.data("prototype").replace(/__name__/g,r.val()),i=Ge(Ge.parseHTML(n)[0]);i.val(r.val()),s.append(i)})),s.submit()}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Je}=window;class Ke{constructor(){this.router=new Ve}extend(t){t.getContainer().on("click",e.openTabsBtn,(e=>{this.openTabs(e,t)}))}openTabs(t,s){const o=Je(t.currentTarget),r=o.data("route"),n=o.data("routeParamName"),i=o.data("tabsBlockedMessage"),a=s.getContainer().find(e.checkedCheckbox);let d=!0;a.each(((e,t)=>{const s=Je(t),o={};o[n]=s.val();const a=window.open(this.router.generate(r,o));a?(a.blur(),window.focus()):d=!1,d||alert(i)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Xe}=window;Xe((()=>{const e=new S("order");e.addExtension(new A),e.addExtension(new $),e.addExtension(new B),e.addExtension(new R),e.addExtension(new H),e.addExtension(new Q),e.addExtension(new Pe),e.addExtension(new Be),e.addExtension(new Ae),e.addExtension(new Le),e.addExtension(new $e),e.addExtension(new De(He,e)),e.addExtension(new Ke)}))})(),window.order=o})();