 ...
 */
class{constructor(e){this.message=e,this.name="LocalizationException"}}},1527:(e,t,r)=>{"use strict";r.d(t,{NumberFormatter:()=>d});var o=r(9475),s=r(3368),n=r(6965);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const It=new(r(7187).EventEmitter),wt="productDeletedFromOrder",Tt="productAddedToOrder",kt="productUpdated",Et="productEditionCanceled",St="productListPaginated",Ot="productListNumberPerPage",{$:Rt}=window;class Ct{constructor(){this.router=new Pt}handleDeleteProductEvent(e){e.preventDefault();const t=Rt(e.currentTarget);window.confirm(t.data("deleteMessage"))&&(t.pstooltip("dispose"),t.prop("disabled",!0),this.deleteProduct(t.data("orderId"),t.data("orderDetailId")))}deleteProduct(e,t){Rt.ajax(this.router.generate("admin_orders_delete_product",{orderId:e,orderDetailId:t}),{method:"POST"}).then((()=>{It.emit(wt,{oldOrderDetailId:t,orderId:e})}),(e=>{e.responseJSON&&e.responseJSON.message&&Rt.growl.error({message:e.responseJSON.message})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:qt}=window;class jt{constructor(){this.router=new Pt}refresh(e){qt.ajax(this.router.generate("admin_orders_get_discounts",{orderId:e})).then((e=>{qt(Ke.list).replaceWith(e)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ir}=window;class wr{constructor(e){this.router=new Pt,this.orderDetailId=e,this.productRow=Ir(`#orderProduct_${this.orderDetailId}`),this.product={},this.currencyPrecision=Ir(V).data("currencyPrecision"),this.priceTaxCalculator=new Mt,this.productEditSaveBtn=Ir(Me),this.quantityInput=Ir(Qe),this.orderPricesRefresher=new Pr,this.availableText=null,this.isOrderTaxIncluded=null,this.productEditInvoiceSelect=null,this.priceTaxIncludedInput=null,this.taxExcluded=null,this.taxIncluded=null,this.taxRate=null,this.priceTaxExcludedInput=null,this.productEditCancelBtn=null,this.quantity=null,this.priceTotalText=null,this.initialTotal=null,this.productRowEdit=null,this.productEditImage=null,this.productEditName=null,this.locationText=null}setupListener(){this.quantityInput.on("change keyup",(e=>{var t;const r=e.target,o=Number(r.value),s=parseInt(Ir(e.currentTarget).data("availableQuantity"),10)-(o-parseInt(this.quantityInput.data("previousQuantity"),10)),n=null==(t=this.availableText)?void 0:t.data("availableOutOfStock");this.quantity=o,this.availableText&&(this.availableText.text(s),this.availableText.toggleClass("text-danger font-weight-bold",s<0)),this.updateTotal();const i=o<=0||s<0&&!n;this.productEditSaveBtn.prop("disabled",i)})),this.productEditInvoiceSelect&&this.productEditInvoiceSelect.on("change",(()=>{this.productEditSaveBtn.prop("disabled",!1)})),this.priceTaxIncludedInput&&this.priceTaxIncludedInput.on("change keyup",(e=>{const t=e.target;this.taxIncluded=parseFloat(t.value),this.taxExcluded=this.priceTaxCalculator.calculateTaxExcluded(this.taxIncluded,this.taxRate,this.currencyPrecision),this.priceTaxExcludedInput&&this.priceTaxExcludedInput.val(this.taxExcluded),this.updateTotal()})),this.priceTaxExcludedInput&&this.priceTaxExcludedInput.on("change keyup",(e=>{const t=e.target;this.taxExcluded=parseFloat(t.value),this.taxIncluded=this.priceTaxCalculator.calculateTaxIncluded(this.taxExcluded,this.taxRate,this.currencyPrecision),this.priceTaxIncludedInput&&this.priceTaxIncludedInput.val(this.taxIncluded),this.updateTotal()})),this.productEditSaveBtn.on("click",(e=>{const t=Ir(e.currentTarget);window.confirm(t.data("updateMessage"))&&(t.prop("disabled",!0),this.handleEditProductWithConfirmationModal(e))})),this.productEditCancelBtn&&this.productEditCancelBtn.on("click",(()=>{It.emit(Et,{orderDetailId:this.orderDetailId})}))}updateTotal(){const e=this.priceTaxCalculator.calculateTotalPrice(this.quantity,this.isOrderTaxIncluded?this.taxIncluded:this.taxExcluded,this.currencyPrecision);this.priceTotalText&&this.priceTotalText.html(e),this.productEditSaveBtn.prop("disabled",e===this.initialTotal)}displayProduct(e){this.productRowEdit=Ir(Fe).clone(!0),this.productRowEdit.attr("id",`editOrderProduct_${this.orderDetailId}`),this.productRowEdit.find("*[id]").each((function(){Ir(this).removeAttr("id")})),this.productEditSaveBtn=this.productRowEdit.find(Me),this.productEditCancelBtn=this.productRowEdit.find(Le),this.productEditInvoiceSelect=this.productRowEdit.find(Ue),this.productEditImage=this.productRowEdit.find($e),this.productEditName=this.productRowEdit.find(Ae),this.priceTaxIncludedInput=this.productRowEdit.find(ze),this.priceTaxExcludedInput=this.productRowEdit.find(He),this.quantityInput=this.productRowEdit.find(Qe),this.locationText=this.productRowEdit.find(Ve),this.availableText=this.productRowEdit.find(Je),this.priceTotalText=this.productRowEdit.find(We),this.priceTaxExcludedInput.val(window.ps_round(e.price_tax_excl,this.currencyPrecision)),this.priceTaxIncludedInput.val(window.ps_round(e.price_tax_incl,this.currencyPrecision)),this.quantityInput.val(e.quantity).data("availableQuantity",e.availableQuantity).data("previousQuantity",e.quantity),this.availableText.data("availableOutOfStock",e.availableOutOfStock),e.orderInvoiceId&&this.productEditInvoiceSelect.val(e.orderInvoiceId),this.taxRate=e.tax_rate,this.initialTotal=this.priceTaxCalculator.calculateTotalPrice(e.quantity,e.isOrderTaxIncluded?e.price_tax_incl:e.price_tax_excl,this.currencyPrecision),this.isOrderTaxIncluded=e.isOrderTaxIncluded,this.quantity=e.quantity,this.taxIncluded=e.price_tax_incl,this.taxExcluded=e.price_tax_excl,this.productEditImage.html(this.productRow.find($e).html()),this.productEditName.html(this.productRow.find(Ae).html()),this.locationText.html(e.location),this.availableText.html(e.availableQuantity),this.priceTotalText.html(this.initialTotal),this.productRow.addClass("d-none").after(this.productRowEdit.removeClass("d-none")),this.setupListener()}handleEditProductWithConfirmationModal(e){const t=Ir(`#orderProduct_${this.orderDetailId} ${he}`),r=t.data("product-id"),o=t.data("combination-id"),s=t.data("order-invoice-id");let n;if(this.priceTaxIncludedInput&&(n=this.orderPricesRefresher.checkOtherProductPricesMatch(this.priceTaxIncludedInput.val(),r,o,s,this.orderDetailId)),null===n)return void this.editProduct(Ir(e.currentTarget).data("orderId"),this.orderDetailId);const i="product"===n?this.priceTaxExcludedInput:this.productEditInvoiceSelect;if(i){new xr({id:"modal-confirm-new-price",confirmTitle:i.data("modal-edit-price-title"),confirmMessage:i.data("modal-edit-price-body"),confirmButtonLabel:i.data("modal-edit-price-apply"),closeButtonLabel:i.data("modal-edit-price-cancel")},(()=>{this.editProduct(Ir(e.currentTarget).data("orderId"),this.orderDetailId)})).show()}}editProduct(e,t){var r,o,s;const n={price_tax_incl:null==(r=this.priceTaxIncludedInput)?void 0:r.val(),price_tax_excl:null==(o=this.priceTaxExcludedInput)?void 0:o.val(),quantity:this.quantityInput.val(),invoice:null==(s=this.productEditInvoiceSelect)?void 0:s.val()};Ir.ajax({url:this.router.generate("admin_orders_update_product",{orderId:e,orderDetailId:t}),method:"POST",data:n}).then((()=>{It.emit(kt,{orderId:e,orderDetailId:t})}),(e=>{e.responseJSON&&e.responseJSON.message&&Ir.growl.error({message:e.responseJSON.message})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Er}=window;class Sr{constructor(){this.router=new Pt}refresh(e){Er.ajax(this.router.generate("admin_orders_get_payments",{orderId:e})).then((e=>{Er(a).remove(),Er(`${i} .card-body`).prepend(e)}),(e=>{e.responseJSON&&e.responseJSON.message&&Er.growl.error({message:e.responseJSON.message})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Or}=window;class Rr{constructor(){this.router=new Pt}refresh(e){Or.getJSON(this.router.generate("admin_orders_get_shipping",{orderId:e})).then((e=>{Or($).text(e.total),Or(A).html(e.html)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Mr}=window;class Lr{constructor(){this.router=new Pt,this.cancelProductForm=Mr(at.form),this.orderId=this.cancelProductForm.data("orderId"),this.orderDelivered=1===parseInt(this.cancelProductForm.data("isDelivered"),10),this.isTaxIncluded=1===parseInt(this.cancelProductForm.data("isTaxIncluded"),10),this.discountsAmount=parseFloat(this.cancelProductForm.data("discountsAmount")),this.currencyFormatter=jr.NumberFormatter.build(this.cancelProductForm.data("priceSpecification")),this.useAmountInputs=!0,this.listenForInputs()}showPartialRefund(){this.hideCancelElements(),Mr(at.toggle.partialRefund).show(),this.useAmountInputs=!0,this.initForm(Mr(at.buttons.save).data("partialRefundLabel"),this.router.generate("admin_orders_partial_refund",{orderId:this.orderId}),"partial-refund")}showStandardRefund(){this.hideCancelElements(),Mr(at.toggle.standardRefund).show(),this.useAmountInputs=!1,this.initForm(Mr(at.buttons.save).data("standardRefundLabel"),this.router.generate("admin_orders_standard_refund",{orderId:this.orderId}),"standard-refund")}showReturnProduct(){this.hideCancelElements(),Mr(at.toggle.returnProduct).show(),this.useAmountInputs=!1,this.initForm(Mr(at.buttons.save).data("returnProductLabel"),this.router.generate("admin_orders_return_product",{orderId:this.orderId}),"return-product")}hideRefund(){this.hideCancelElements(),Mr(at.table.actions).show()}hideCancelElements(){Mr(at.toggle.standardRefund).hide(),Mr(at.toggle.partialRefund).hide(),Mr(at.toggle.returnProduct).hide(),Mr(at.table.actions).hide()}initForm(e,t,r){this.updateVoucherRefund(),this.cancelProductForm.prop("action",t),this.cancelProductForm.removeClass("standard-refund partial-refund return-product cancel-product").addClass(r),Mr(at.buttons.save).html(e),Mr(at.table.header).html(e),Mr(at.checkboxes.restock).prop("checked",this.orderDelivered),Mr(at.checkboxes.creditSlip).prop("checked",!0),Mr(at.checkboxes.voucher).prop("checked",!1)}listenForInputs(){Mr(document).on("change",at.inputs.quantity,(e=>{const t=Mr(e.target),r=t.parents(at.table.cell).find(at.inputs.amount),o=parseInt(t.val(),10);if(o<=0)return r.val(0),void this.updateVoucherRefund();const s=this.isTaxIncluded?"productPriceTaxIncl":"productPriceTaxExcl",n=parseFloat(t.data(s)),i=parseFloat(t.data("amountRefundable")),a=n*o<i?n*o:i,d=parseFloat(r.val());this.useAmountInputs&&this.updateAmountInput(t),(""===r.val()||0===d||d>a)&&(r.val(a),this.updateVoucherRefund())})),Mr(document).on("change",at.inputs.amount,(()=>{this.updateVoucherRefund()})),Mr(document).on("change",at.inputs.selector,(e=>{const t=Mr(e.target),r=t.parents(at.table.cell).find(at.inputs.quantity),o=parseInt(r.data("quantityRefundable"),10),s=parseInt(r.val(),10);t.is(":checked")?(Number.isNaN(s)||0===s)&&r.val(o):r.val(0),this.updateVoucherRefund()}))}updateAmountInput(e){const t=e.parents(at.table.cell).find(at.inputs.amount),r=parseInt(e.val(),10);if(r<=0)return void t.val(0);const o=this.isTaxIncluded?"productPriceTaxIncl":"productPriceTaxExcl",s=parseFloat(e.data(o)),n=parseFloat(e.data("amountRefundable")),i=s*r<n?s*r:n,a=parseFloat(t.val());(""===t.val()||0===a||a>i)&&t.val(i)}getRefundAmount(){let e=0;return this.useAmountInputs?Mr(at.inputs.amount).each(((t,r)=>{const o=parseFloat(r.value);e+=Number.isNaN(o)?0:o})):Mr(at.inputs.quantity).each(((t,r)=>{const o=Mr(r),s=this.isTaxIncluded?"productPriceTaxIncl":"productPriceTaxExcl",n=parseFloat(o.data(s)),i=parseInt(o.val(),10);e+=i*n})),e}updateVoucherRefund(){const e=this.getRefundAmount();this.updateVoucherRefundTypeLabel(Mr(at.radios.voucherRefundType.productPrices),e);const t=e-this.discountsAmount;this.updateVoucherRefundTypeLabel(Mr(at.radios.voucherRefundType.productPricesVoucherExcluded),t),t<0?(Mr(at.radios.voucherRefundType.productPricesVoucherExcluded).prop("checked",!1).prop("disabled",!0),Mr(at.radios.voucherRefundType.productPrices).prop("checked",!0),Mr(at.radios.voucherRefundType.negativeErrorMessage).show()):(Mr(at.radios.voucherRefundType.productPricesVoucherExcluded).prop("disabled",!1),Mr(at.radios.voucherRefundType.negativeErrorMessage).hide())}updateVoucherRefundTypeLabel(e,t){var r;const o=e.data("defaultLabel"),s=e.parents("label"),n=this.currencyFormatter.format(t),i=null==(r=null==s?void 0:s.get(0))?void 0:r.lastChild;i&&(i.nodeValue=`\n      ${o} ${n}`)}showCancelProductForm(){const e=this.router.generate("admin_orders_cancellation",{orderId:this.orderId});this.initForm(Mr(at.buttons.save).data("cancelLabel"),e,"cancel-product"),this.hideCancelElements(),Mr(at.toggle.cancelProducts).show()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Fr}=window;class Dr{constructor(){this.router=new Pt,this.invoiceNoteManager=new gt}refresh(e){Fr.getJSON(this.router.generate("admin_orders_get_documents",{orderId:e})).then((e=>{Fr(F).text(e.total),Fr(D).html(e.html),this.invoiceNoteManager.setupListeners()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Vr}=window;Vr((()=>{const r="free_shipping";new ft,new zr;const o=new Ar,s=new Gr(Vr(_e)),n=new Zr;o.listenForProductPack(),o.listenForProductDelete(),o.listenForProductEdit(),o.listenForProductAdd(),o.listenForProductPagination(),o.listenForRefund(),o.listenForCancelProduct(),s.listenForSearch(),s.onItemClickedCallback=e=>n.setProduct(e),Vr(t).on("click",(e=>{Vr(e.currentTarget).closest("tr").next(":first").toggleClass("d-none")})),function(){const e=Vr(u);Vr(l).on("input",(()=>{e.prop("disabled",!1)}))}(),function(){const e=Vr(ht);Vr(ut).on("input",(()=>{e.prop("disabled",!1)}))}(),function(){const e=Vr(y),t=Vr(I);Vr(P).on("change",(r=>{const o=Vr(r.currentTarget),s=Vr("option:selected",o),n=o.val();t.css("background-color",s.data("background-color")),t.toggleClass("is-bright",void 0!==s.data("is-bright")),e.prop("disabled",parseInt(n,10)===e.data("orderStatusId"))}))}(),new gt;const i=new Qr;i.listenForPredefinedMessageSelection(),i.listenForFullMessagesOpen(),Vr(d).on("click",(e=>{e.preventDefault(),function(){const e=Vr(c),t=Vr(d),r=t.hasClass("is-opened");r?(t.removeClass("is-opened"),e.addClass("d-none")):(t.addClass("is-opened"),e.removeClass("d-none"));t.find(".material-icons").text(r?"add":"remove")}()})),Vr(ct).on("click",(e=>{e.preventDefault(),function(){const e=Vr(lt),t=Vr(ct),r=t.hasClass("is-opened");t.toggleClass("is-opened",!r),e.toggleClass("d-none",r);t.find(".material-icons").text(r?"add":"remove")}()})),Vr(dt).on("click",(()=>{const t=document.title;document.title=Vr(e).data("orderTitle"),window.print(),document.title=t})),function(){const e=Vr(h),t=e.find("form"),o=e.find(p),s=e.find(x),n=t.find(v),i=n.closest(".form-group");e.on("shown.bs.modal",(()=>{Vr(b).prop("disabled",!0)})),t.find(m).on("keyup",(e=>{const t=Vr(e.currentTarget).val();Vr(b).prop("disabled",0===t.trim().length)})),t.find(_).on("change",(e=>{const t=Vr(e.currentTarget).is(":checked");o.prop("disabled",t)})),t.find(f).on("change",(e=>{const o=Vr(e.currentTarget).val(),a=t.find(g);"amount"===o?(s.removeClass("d-none"),a.html(a.data("currencySymbol"))):s.addClass("d-none"),"percent"===o&&a.html("%"),n.prop("disabled",o===r),i.toggleClass("d-none",o===r)}))}(),function(){const e=Vr(E);Vr(S).on("click",(t=>{e.find(O).val(Vr(t.currentTarget).data("addressType"))}))}(),Vr(it).find(".nav-tabs li:first-child a").tab("show")}))})(),window.order_view=o})();