...
class Ps_NewProducts extends Module implements WidgetInterface
{
    ...
    {
        if (!$this->isCached('tab.tpl', $this->getCacheId('Ps_NewProducts-tab')))
            Ps_NewProducts::$cache_new_products = $this->getNewProducts();

        if (Ps_NewProducts::$cache_new_products === false)
            return false;

        return $this->display(__FILE__, 'tab.tpl', $this->getCacheId('Ps_NewProducts-tab'));
    }
    ...
    public function hookdisplayHomeTabContent($params)
    {
        ...
        return $this->display(__FILE__, 'tab_content.tpl', $this->getCacheId('Ps_NewProducts-home'));
    }
