...
{block name="field"}   
    ...
    {elseif $input.name=='IMPORT_EXPORT_IMAGE_GREY'}
        <div class="col-lg-9">
                <span class="switch prestashop-switch fixed-width-lg">
                <input id="IMPORT_EXPORT_IMAGE_GREY_on" type="radio" value="1" name="IMPORT_EXPORT_IMAGE_GREY" />
                <label for="IMPORT_EXPORT_IMAGE_GREY_on">Yes</label>
                <input id="IMPORT_EXPORT_IMAGE_GREY_off" type="radio" checked="checked" value="0" name="IMPORT_EXPORT_IMAGE_GREY" />
                <label for="IMPORT_EXPORT_IMAGE_GREY_off">No</label>
