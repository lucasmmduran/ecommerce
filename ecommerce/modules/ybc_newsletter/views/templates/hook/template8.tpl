                        ...
                        <div class="ynp-inner">
                            ...
                            <div class="ynp-inner-wrapper">
                                {if isset($YBC_NEWSLETTER_POPUP_TITLE) && $YBC_NEWSLETTER_POPUP_TITLE != ''}
                                    <h1>{if $YBC_NEWSLETTER_LOGO}<span class="nlt_logo"><img src="{$YBC_NEWSLETTER_LOGO|escape:'html':'UTF-8'}" alt="nth-{$YBC_NEWSLETTER_LOGO|escape:'html':'UTF-8'}" /></span>{/if}
                                    <span class="nlt_title">{$YBC_NEWSLETTER_POPUP_TITLE|escape:'html':'UTF-8'}{if isset($YBC_NEWSLETTER_POPUP_SUBTITLE) && $YBC_NEWSLETTER_POPUP_SUBTITLE != ''} <span class="main_color">{$YBC_NEWSLETTER_POPUP_SUBTITLE|escape:'html':'UTF-8'}</span>{/if}</span></h1>
                                {/if}
