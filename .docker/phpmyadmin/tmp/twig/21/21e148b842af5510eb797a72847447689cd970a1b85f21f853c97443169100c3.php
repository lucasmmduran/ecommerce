...
echo _gettext("Git information missing!");
                ...
                // line 25
                echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [$___internal_parse_33_]);
                // line 39
                echo "    </div>
  ";
            }
...
";
    ...
    {
        return new Source("", "footer.twig", "/var/www/.docker/phpmyadmin/templates/footer.twig");
    }
}
